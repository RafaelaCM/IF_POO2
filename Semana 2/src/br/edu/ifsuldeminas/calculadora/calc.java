	...
	private void initialize() {
		...
		btnOne.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String atualValorDaTextField = textFieldResultado.getText();
				String novoValorDaTextField = atualValorDaTextField + "1";
				textFieldResultado.setText(novoValorDaTextField);
